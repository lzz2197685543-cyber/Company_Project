...
class Shopee_Financial_Data_Payment:
...
async def run_shopee_financial_payment():
    ...
    for shop_name in name_list:
        shein = Shopee_Financial_Data_Payment(shop_name,start_time,end_time)
        await shein.get_all_page()


if __name__ == '__main__':
    asyncio.run(run_shopee_financial_payment())