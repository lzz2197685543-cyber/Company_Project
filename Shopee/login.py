...
class ShopeeLogin:
    def __init__(self,name,account_data):
        ...
        self.stop_api_url = "http://127.0.0.1:6873/api/v1/browser/stop"
    ...
    async def check_network(self):
        ...
        for attempt in range(2):
            try:
                await self.page.goto('https://seller.scs.shopee.cn/login',timeout=15000,wait_until='load')
                # 检查页面是否正常
    ...
    async def login(self):
        ...
        try:
            ...
            # 输入密码
            # pwd_selectors = [
            #     '#ssc-input.ssc-input-type-password.ssc-input-size-large.ssc-input-shape-default.ssc-input-has-prefix input',
            #     "input[name='password']",
            #     "input[type='password']",
