...
from services.Chinese_Financial_Statements.detail_taobao import  TaoBao_FinancialDetailService
...
def fetch_financial_detail_expenses(period):
    """获取账务明细费用（只线上）"""
    service = TaoBao_FinancialDetailService()
...
async def main():
    ...
    output_file = output_dir / f"financial_statement_{period}_淘宝淘气精灵.xlsx"
