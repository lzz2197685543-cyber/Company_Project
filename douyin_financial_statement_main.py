...
from services.Chinese_Financial_Statements.details_douyin import DouYin_FinancialDetailService
...
def fetch_financial_detail_expenses(period):
    """获取账务明细费用（只线上）"""
    service = DouYin_FinancialDetailService()
...
async def main():
    ...
    output_file = output_dir / f"financial_statement_{period}_抖音.xlsx"
