...
from services.Chinese_Financial_Statements.details_1688 import FinancialDetailService
...
def fetch_financial_detail_expenses(period):
    """获取账务明细费用（只线上）"""
    service = FinancialDetailService()
...
async def main():
    ...
    output_file = output_dir / f"financial_statement_{period}_1688.xlsx"
