...
class BaseStorage:
    def __init__(self,mysql_conf:dict,redis_conf:dict,redis_prefix:str,job:str):
        # Mysql
        self.db=pymysql.connect(charset="utf8mb4",autocommit=True,**mysql_conf)
        self.cursor=self.db.cursor()

        # Redis
        self.redis=redis.Redis(decode_responses=True,**redis_conf)
