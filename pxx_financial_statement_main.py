...
from services.Chinese_Financial_Statements.details_pxx import Pxx_FinancialDetailService
...
def fetch_financial_detail_expenses(period):
    """获取账务明细费用（只线上）"""
    service = Pxx_FinancialDetailService()
...
async def main():
    ...
    output_file = output_dir / f"financial_statement_{period}_拼多多.xlsx"
